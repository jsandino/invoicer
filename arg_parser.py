...
class ArgParser:
  def __init__(self):
    ...
    self.parser.add_argument("-l", "--logo", metavar="image_file", help="path to image logo to include in header")
    self.parser.add_argument("-d", "--details", metavar="details_file", required=True, help="path to json file with invoice details")
    self.parser.add_argument("-i", "--items", metavar="items_file", required=True, help="path to csv file with invoice items")
